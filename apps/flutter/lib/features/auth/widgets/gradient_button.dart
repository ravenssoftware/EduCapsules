...
/// The full-width purple gradient Login button with a trailing arrow icon
/// and a loading spinner while [isLoading] is true. Disabled (and visually
/// dimmed) whenever [onPressed] is null, which the caller uses to prevent
